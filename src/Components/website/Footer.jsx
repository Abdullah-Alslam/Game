    ...
    <section className="bg-[url(/img/pattern.png)] text-white">
          ...
          <div className="flex-1 grid sm:grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#252525] p-5 rounded">
              ...
              {post.map((item, index) => (
                <div
                  key={index}
                  className="flex gap-4 mb-5 p-2 rounded hover:scale-105 hover:shadow-lg transition-transform duration-300"
                >
                  <img
                    src={item.src}
                    alt="Post image"
            ...
            <div className="bg-[#252525] p-5 rounded">
              ...
              {comment.map((item, index) => (
                <div
                  key={index}
                  className="flex gap-4 items-center mb-5 p-2 rounded hover:scale-105 hover:shadow-lg transition-transform duration-300"
                >
                  <img
                    src={item.src}
                    alt="Author avatar"
      ...
      <div className="bg-[#252525] py-4">
        <div className="text-center text-[#a1aeae] text-sm">
          ...
          <Link
            to="https://www.linkedin.com/in/abdullah-abd-al-salam-a8ab05357/?trk=opento_sprofile_goalscard"
            target="_blank"
            rel="noopener noreferrer"
          >
            <span className="text-[#146fff]">Abdullah Abd Al-Salam</span>
          </Link>
        </div>
      </div>
    </section>
